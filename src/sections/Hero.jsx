  ...
  return (
    ...
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center min-h-[75vh]">
          ...
          <div className="flex flex-col justify-center order-2 lg:order-1">
            ...
            <motion.h1
              ...
              className="text-4xl sm:text-5xl lg:text-6xl xl:text-[5.5rem] font-bold leading-[1.05] tracking-tight mb-6"
              style={{
            ...
            >
              ...
              <button
                ...
                className="font-semibold px-8 py-4 rounded-full text-sm tracking-wide transition-all duration-300 hover:scale-[1.03] cursor-pointer"
                style={{
                  color: 'var(--text-primary)',
                  background: 'var(--bg-surface)',
                  border: '1px solid var(--border)',
      ...
      >
        ...
        <motion.div className="w-px h-8" style={{ background: 'var(--border)' }}>
          <motion.div
