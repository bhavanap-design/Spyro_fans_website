  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse at center, rgba(0,123,201,0.15) 0%, transparent 70%)',
        }}
      />
      <picture>
            ...
            style={
              selected === s
                ? {
                    background: '#007BC9',
                    color: '#fff',
                    boxShadow: '0 0 16px rgba(0,123,201,0.35)',
                  }
                : {
        ...
        >
          {product.is3D ? (
            ...
            >
              ...
              >
                {product.fanType === 'hvls' ? (
                  <HVLSFan3D mode="product" />
                ) : (
                  <FloorFan3D />
                )}
              </Suspense>
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="flex flex-wrap gap-3 pt-2">
            <button
              ...
              style={{
                background: '#007BC9',
                boxShadow: '0 4px 20px rgba(0, 123, 201, 0.3)',
              }}
            >
              Request Quote
            </button>
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <div
            className="hidden lg:block flex-grow h-px mb-4"
