...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-12 flex flex-col gap-2">

        {/* Row 1: Logo | Nav links | Make in India */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-2">

          {/* Left: Logo */}
          <a href="#" className="flex items-center gap-1 group">
            <svg className="h-6 w-auto" viewBox="0 0 46 50">
        ...
        <p className="text-sm text-center md:text-left" style={{ color: 'var(--text-muted)' }}>
          © 2026 SpyroFans. All rights reserved.
        </p>
